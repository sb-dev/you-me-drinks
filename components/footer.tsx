...
const navigation = {
  ...
  social: [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/ymdrinks/',
      icon: (props: any) => (
    ...
    {
      name: 'Youtube',
      href: 'https://www.youtube.com/channel/UCQeiyaycCoy2Rr1Ta-kepuQ',
      icon: (props: any) => (
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/youmedrinks',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/youmedrinks',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/sb-dev/you-me-drinks',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
const Footer = () => { 
  return (
    <footer className="bg-white pt-16" aria-labelledby="footer-heading">
      <section className="border-t border-[#284D76] pt-6">
        ...
        <div className="max-w-7xl mx-auto py-8 overflow-hidden">
          ...
          <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
            {navigation.content.map((item) => (
              <div key={item.name} className="px-5 py-2">
                <a href={item.href} className="text-base text-[#284D76] hover:underline underline-offset-2">
                  {item.name}
                </a>
              </div>
            ))}
          ...
          <p className="mt-8 text-center text-base text-gray-400">&copy; {new Date().getFullYear()} YouMeDrinks, Inc. All rights reserved.</p>
        </div>
      </section>
    </footer>
  )
