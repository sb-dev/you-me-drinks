...
const Header = () => (
<Disclosure as="header" className="bg-white shadow border-b border-[#284D76]">
      {({ open }) => (
        <>
          <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-8">
            <div className="relative flex justify-between h-16">
              <div className="flex relative z-10 px-2 lg:px-0">
                <div className="flex-shrink-0 flex items-center text-3xl font-['Londrina_Solid'] space-x-1 text-[#284D76]">
            ...
            <nav className="hidden h-16 lg:py-2 lg:flex lg:space-x-8" aria-label="Global">
              {navigation.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
